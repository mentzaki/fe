 ...
 * @author yew_mentzaki
 */
public class FTextBox extends FElement {
    ...
    public FTextBox(String text, int x, int y, int width, int height) {
        this.text = text;
        this.x = x;
        this.y = y;
        this.width = width;
    ...
    public FTextBox(String image, String text, int x, int y, int width, int height) {
